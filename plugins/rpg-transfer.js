...
async function handler(m, { conn, args, usedPrefix, command }) {
    if (confirmation[m.sender]) return m.reply('estas haciendo una transferencia,you are making a transfer')
...
function special(type) {
    ...
    let special = (['common', 'uncommon', 'hades', 'legendary', 'pet'].includes(b) ? ' Crate' : '')
    return special
}
